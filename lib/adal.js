...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext = function (config) {
        ...
        this.CONSTANTS = {
            ...
            STORAGE: {
                ...
                AUTHENTICATION_MODE: 'adal.authenticationmode'
            },
            RESOURCE_DELIMETER: '|',
    ...
    AuthenticationContext.prototype.login = function (loginStartPage) {
        ...
        if (this.config.extraQueryParameter && this.config.extraQueryParameter.indexOf('&login_hint') !== -1) {
            window.requestType = this.REQUEST_TYPE.LOGIN;
            window.adalCallback = this.callback;
            var self = this;
            this._renewIdToken(function (errorDesc, token, error) {
                if (!token) {
                    self._loginInteractive(loginStartPage);
                }
            });
        }
        else {
            this._loginInteractive(loginStartPage);
        }
    };
    ...
    */
    AuthenticationContext.prototype._loginInteractive = function (loginStartPage) {
        ...
        if (this.config.displayCall) {
            ...
            this._saveItem(this.CONSTANTS.STORAGE.AUTHENTICATION_MODE, this.AUTHENTICATION_MODES.POPUP);
            this._loginPopup(urlNavigate);
        }
        else {
            this._saveItem(this.CONSTANTS.STORAGE.AUTHENTICATION_MODE, this.AUTHENTICATION_MODES.REDIRECT);
    ...
    */
    ...
    AuthenticationContext.prototype.acquireToken = function (resource, callback) {
        ...
        if (this._activeRenewals[resource]) {
            ...
            this._saveItem(this.CONSTANTS.STORAGE.AUTHENTICATION_MODE, this.AUTHENTICATION_MODES.IFRAME);
  ...
  */
    ...
    AuthenticationContext.prototype.clearCache = function () {
        ...
        this._saveItem(this.CONSTANTS.STORAGE.AUTHENTICATION_MODE, '');
