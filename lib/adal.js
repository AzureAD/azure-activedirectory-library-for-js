...
AuthenticationContext.prototype.acquireToken = function (resource, callback) {
    ...
    if ((this._activeRenewals[resource] ||
        (window.parent && window.parent.AuthenticationContext()._activeRenewals[resource])) &&
        (window.loadframeStatus[resource] !== this.CONSTANTS.LOADFRAME_EXPIRED ||
        window.parent.loadframeStatus[resource] !== this.CONSTANTS.LOADFRAME_EXPIRED)) {
