...
var AuthenticationContext = (function () {
     ...
     *  @property {(string|Object)} cacheLocation - Sets browser storage to either 'localStorage', 'sessionStorage' or a custom storage that is passed. Defaults to 'sessionStorage'.
    ...
    */
    ...
    AuthenticationContext.prototype._saveItem = function (key, obj, preserve) {
        ...
        if (this.config && this.config.cacheLocation && this.config.cacheLocation === 'localStorage') {
            ...
            // use custom storage
            this.config.cacheLocation.setItem(key, obj);
            return true;
        }
    ...
    AuthenticationContext.prototype._getItem = function (key) {
        ...
        if (this.config && this.config.cacheLocation && this.config.cacheLocation === 'localStorage') {
            ...
            // use custom storage
            return this.config.cacheLocation.getItem(key);
        }
