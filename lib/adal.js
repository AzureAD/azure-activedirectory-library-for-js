                ...
                if (config) {
                    ...
                    if (tokenStored) {
                        ...
                        if (authService.loginInProgress()) {
                            ...
                            var deferRequest = $q.defer();
                            authService.acquireToken(resource, function (err, token) {
                                if (err) {
                                    this._logstatus('err :' + error);
                                    deferRequest.reject(err);
                                } else {
    ...
    var AdalService = function () {
        ...
        this.init = function (configOptions, httpProvider) {
            if (configOptions) {
                ...
                configOptions.redirectUri = configOptions.redirectUri || window.location;
                configOptions.postLogoutRedirectUri = configOptions.postLogoutRedirectUri || window.location;
