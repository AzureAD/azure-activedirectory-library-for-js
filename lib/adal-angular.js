                        ...
                        if (requestInfo.stateMatch) {
                            if (requestInfo.requestType === _adal.REQUEST_TYPE.RENEW_TOKEN) {
                                ...
                                if (window.parent !== window) { // 
                                    ...
                                    if (token) {
                                        if ($window.parent.adalCallback && typeof $window.parent.adalCallback === 'function')
                                            $window.parent.adalCallback(_adal._getItem(_adal.CONSTANTS.STORAGE.ERROR_DESCRIPTION), _adal._getItem(_adal.CONSTANTS.STORAGE.IDTOKEN), _adal._getItem(_adal.CONSTANTS.STORAGE.ERROR));
                                    }
                            ...
                            var authenticationMode = _adal._getItem(_adal.CONSTANTS.STORAGE.AUTHENTICATION_MODE);
                            // redirect to login start page
                            if (authenticationMode && authenticationMode !== _adal.AUTHENTICATION_MODES.POPUP) {
