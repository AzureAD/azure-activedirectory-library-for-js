        ...
        AdalModule.factory('ProtectedResourceInterceptor', ['adalAuthenticationService', '$q', '$rootScope', '$templateCache', function (authService, $q, $rootScope, $templateCache) {
            ...
            return {
                request: function (config) {
                    if (config) {
                        //preventAccessTokenInjection, if set true will not inject the access token.
                        var preventAccessTokenInjection = false;
                        if(config.preventAccessTokenInjection === true){
                        ...
                        if (tokenStored) {
                            ...
                            if(!preventAccessTokenInjection)
