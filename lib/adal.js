  ...
  */
    ...
    */
    AuthenticationContext.prototype._matchNonce = function (user) {
        const requestNonce = this._getItem(this.CONSTANTS.STORAGE.NONCE_IDTOKEN);
    ...
    */
    AuthenticationContext.prototype._matchState = function (requestInfo) {
        const loginStates = this._getItem(this.CONSTANTS.STORAGE.STATE_LOGIN);
    ...
    AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource) {
        ...
        const urlNavigate = this.instance + tenant + '/oauth2/authorize' + this._serialize(responseType, this.config, resource) + this._addLibMetadata();
