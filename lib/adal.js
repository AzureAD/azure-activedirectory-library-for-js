...
AuthenticationContext.prototype.login = function () {
    ...
    var urlNavigate = this._getNavigateUrl('id_token', null, false) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
...
AuthenticationContext.prototype._renewToken = function (resource, callback) {
    ...
    var urlNavigate = this._getNavigateUrl('token', resource, true) + '&prompt=none&login_hint=' + encodeURIComponent(this._user.userName);
...
AuthenticationContext.prototype._renewIdToken = function (callback) {
    ...
    var urlNavigate = this._getNavigateUrl('id_token', null, true) + '&prompt=none&login_hint=' + encodeURIComponent(this._user.userName);
...
AuthenticationContext.prototype._serialize = function (responseType, obj, resource, forFrame) {
    ...
    if (obj !== null) {
        ...
        var redirectUri = (forFrame ? obj.frameRedirectUri : obj.redirectUri);
