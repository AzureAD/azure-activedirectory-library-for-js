                    ...
                    if (requestInfo.stateMatch) {
                        if (typeof _adal.callback === 'function') {
                            ...
                            if (requestInfo.requestType === _adal.REQUEST_TYPE.RENEW_TOKEN) {
                                ...
                                _adal.callback(_adal._getItem(_adal.CONSTANTS.STORAGE.ERROR_DESCRIPTION), _adal._createUser(_adal._getItem(_adal.CONSTANTS.STORAGE.IDTOKEN)));
                                return;
                            }
                        } else {
