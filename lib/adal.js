        ...
        var pollTimer = window.setInterval(function () {
            ...
            try {
                ...
                if (encodeURI(popUpWindowLocation.href).indexOf(encodeURI(registeredRedirectUri)) != -1) {
                    if (that.isAngular) {
                        that._onPopUpHashChanged(popUpWindowLocation.hash);
                    }
                    else {
    ...
    AuthenticationContext.prototype.getRequestInfo = function (hash) {
        ...
        if (parameters) {
            ...
            if (parameters.hasOwnProperty(this.CONSTANTS.ERROR_DESCRIPTION) ||
                ...
                if (stateResponse === this._getItem(this.CONSTANTS.STORAGE.STATE_LOGIN)) {//loginRedirect
                ...
                else if (stateResponse === this._getItem(this.CONSTANTS.STORAGE.STATE_RENEW)) {//acquireTokenRedirect
