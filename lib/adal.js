...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype._guid = function () {
        ...
        if (cryptoObj && cryptoObj.getRandomValues) {
            ...
            return decimalToHex(buffer[0]) + decimalToHex(buffer[1]) + '-' + decimalToHex(buffer[2]) + '-' + decimalToHex(buffer[3]) + '-' +
              decimalToHex(buffer[4]) + '-' + decimalToHex(buffer[5]) + decimalToHex(buffer[6]) + decimalToHex(buffer[7]);
        }
        else {
