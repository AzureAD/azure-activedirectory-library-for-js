...
AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource) {
    ...
    var urlNavigate = this.instance + tenant + '/oauth2/authorize' + this._serialize(responseType, this.config, resource) + this._addXClientParameters();
...
AuthenticationContext.prototype._addXClientParameters = function () {
    // x-client-SKU
    // x-client-Ver
