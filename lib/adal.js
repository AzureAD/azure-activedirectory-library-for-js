...
var AuthenticationContext = (function () {
  ...
  */
    ...
    AuthenticationContext.prototype._addHintParameters = function (urlNavigate) {
        // include hint params only if upn/sid is present
        if (this._user && this._user.profile) {
            if (this._user.profile.sid) {
            ...
            if (!this._urlContainsQueryStringParameter("domain_hint", urlNavigate) && this._user.profile.upn && this._user.profile.upn.indexOf('@') > -1) {
