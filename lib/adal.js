...
var AuthenticationContext = (function () {
     ...
     *  @property {boolean} appendIdTokenHintToPostLogoutRedirectUri - if set to true, append Id Token Hint to postLogoutRedirectUri as defined in openid-connect-core section 3.1.2.1
    ...
    AuthenticationContext = function (config) {
        ...
        if(this.config.appendIdTokenHintToPostLogoutRedirectUri === undefined) {
          this.config.appendIdTokenHintToPostLogoutRedirectUri = false;
        }
  ...
  */
    ...
    AuthenticationContext.prototype.logOut = function () {
        // get token before clearCache otherwise it will be undefined
        ...
        if (this.config.logOutUri) {
            ...
            if (this.config.postLogoutRedirectUri) {
                ...
                if(this.config.appendIdTokenHintToPostLogoutRedirectUri) {
