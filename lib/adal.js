...
var AuthenticationContext = (function () {
     ...
     *  @property {boolean} appendIdTokenHintToLogoutUri - if set to true, append Id Token Hint to postLogoutRedirectUri as defined in openid-connect-core section 3.1.2.1
    ...
    AuthenticationContext = function (config) {
        ...
        if(this.config.appendIdTokenHintToLogoutUri === undefined) {
          this.config.appendIdTokenHintToLogoutUri = false;
        }
    ...
    AuthenticationContext.prototype.logOut = function () {
        ...
        if (this.config.logOutUri) {
            ...
            if (this.config.postLogoutRedirectUri) {
                ...
                if(this.config.appendIdTokenHintToLogoutUri) {
