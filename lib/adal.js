...
AuthenticationContext.prototype._loadFrame = function (urlNavigate) {
    // This trick overcomes iframe navigation in IE
    // IE does not load the page consistently in iframe
    var self = this;
    setTimeout(function () {
        var frameHandle = self._addAdalFrame('adalRenewFrame');
            ...
            if (requestInfo.parameters.hasOwnProperty('id_token')) {
                ...
                if (this._user && this._user.profile) {
                    if (this._user.profile.nonce !== this._getItem(this.CONSTANTS.STORAGE.NONCE_IDTOKEN)) {
                        ...
                        this._saveItem(this.CONSTANTS.STORAGE.ACCESS_TOKEN_KEY + this.config.clientId, requestInfo.parameters['id_token']);
                        this._saveItem(this.CONSTANTS.STORAGE.EXPIRATION_KEY + this.config.clientId, this._user.profile.exp);
                    }
                }
            }
        } else {
