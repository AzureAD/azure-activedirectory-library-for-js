...
describe('Adal', function () {
    ...
    it('navigates user to login by default', function () {
        ...
        adal.login();
        expect(adal.promptUser).toHaveBeenCalledWith(DEFAULT_INSTANCE + conf.tenant + '/oauth2/authorize?response_type=id_token&client_id=client&resource=default%20resource&resource=default%20resource&redirect_uri=contoso_site&state=33333333-3333-4333-b333-333333333333'
    ...
    it('calls displaycall if given for login', function () {
        ...
        adal.login();
        expect(adal.config.displayCall).toHaveBeenCalledWith(DEFAULT_INSTANCE + conf.tenant + '/oauth2/authorize?response_type=id_token&client_id=client&resource=default%20resource&redirect_uri=contoso_site&state=33333333-3333-4333-b333-333333333333' 
